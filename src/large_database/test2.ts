...
export const highCardinalityTest = async () => {
    try{
        console.log('highCardinalityTest');
        ...
        */
        ...
        question: "What are all the genres of Gerald Moore?",
        proper_nouns: "",
        });
        ...
        */
        ...
        question: "What are all the genres of Gerald Moore songs?",
        });
